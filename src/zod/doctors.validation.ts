...
export const createDoctorZodSchema = z.object({
    ...
    currentWorkPlace: z.string().min(3, "Current Working Place must be at least 3 characters long"),
...
export const updateDoctorZodSchema = z.object({
    ...
    currentWorkPlace: z.string().min(3, "Current Working Place must be at least 3 characters long").optional(),
