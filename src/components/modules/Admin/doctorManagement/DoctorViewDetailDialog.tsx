...
const DoctorViewDetailDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-full md:min-w-2xl lg:min-w-5xl max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="flex flex-col  items-center  gap-6 p-6 bg-linear-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg mb-6">
              ...
              <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                ...
                {doctor?.avgRating !== undefined && (
                  <Badge variant="secondary" className="text-sm">
                    ...
                    {doctor.avgRating.toFixed(1)} Rating
                  </Badge>
                )}
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <InfoRow
                    ...
                    value={doctor?.currentWorkPlace || "Not specified"}
                  />
                </div>
                <div className="flex items-start gap-3">
                ...
                {doctor?.avgRating !== undefined && (
                  <div className="flex items-start gap-3">
                    ...
                    <InfoRow
                      ...
                      value={`${doctor.avgRating!.toFixed(1)} / 5.0`}
                    />
                  </div>
                )}
              </div>
