...
import { useSpecialitySelection } from "@/hooks/specialityHooks/useSpecialitySelection";
...
function doctorFormDialog({ open, onClose, onSuccess, doctor, specialities }: IDoctorFormDialogProps) {
        ...
        <form ref={formRef} action={formAction} className="flex flex-col flex-1 min-h-0">
          <div className="flex-1 overflow-y-auto px-6 space-y-4 pb-4">
            ...
            <SpecialtyMultiSelect
              ...
              availableSpecialties={specialitySelection.getAvailableSpecialties(specialities!)}
              isEdit={isEdit}
              onCurrentSpecialtyChange={specialitySelection.setCurrentSpecialtyId}
            ...
            <Field>
              ...
              <Input id="address" name="address" placeholder="123 Main St, City, Country" defaultValue={state?.formData?.address || (isEdit ? doctor?.address : "")} />
            ...
            <Field>
              ...
              <Input id="experience" name="experience" type="number" placeholder="5" defaultValue={state?.formData?.experience || (isEdit ? doctor?.experience : "")} min="0" />
            ...
            <Field>
              <FieldLabel htmlFor="currentWorkPlace">Current Working Place</FieldLabel>
              <Input
                id="currentWorkPlace"
                name="currentWorkPlace"
                placeholder="City Hospital"
                defaultValue={state?.formData?.currentWorkPlace || (isEdit ? doctor?.currentWorkPlace : "")}
              />
              <InputFieldError state={state} field="currentWorkPlace" />
            </Field>

            <Field>
              <FieldLabel htmlFor="designation">Designation</FieldLabel>
              <Input id="designation" name="designation" placeholder="Senior Consultant" defaultValue={state?.formData?.designation || (isEdit ? doctor?.designation : "")} />
            ...
            {!isEdit && (
              <Field>
                ...
                {selectedFile && (
                  <div className="flex flex-col items-center w-40! h-40 border-red-600">
                    <Image
                      ...
                      width={30}
                      height={30}
                      className="mb-2 rounded-full w-full h-full object-cover"
                    />
                  </div>
                )}
