          ...
          <div className="space-y-4 p-4 bg-white rounded-lg border-2 border-primary/20 shadow-sm">
            ...
            <div className="space-y-3 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {suggestedDoctors.map((doctor, index) => (
                <div key={doctor.id || index} className="p-4 bg-gradient-to-br from-primary/5 to-white rounded-lg border border-primary/20 hover:shadow-md transition-shadow flex-1">
                  <div className="flex flex-col lg:flex-row items-start gap-4">
                    ...
                    {/* Doctor Info */}
                    <div className="flex-1 space-y-2 min-h-[180px] flex flex-col w-full">
                      {/* Doctor Photo */}
                      <div className="shrink-0">
                        {doctor.profilePhoto ? (
                      ...
                      <div className="flex items-center flex-row justify-between pt-2 border-t border-primary/20 mt-auto">
                        <div className="flex items-center gap-2">
